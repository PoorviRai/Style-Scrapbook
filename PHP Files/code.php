...
<div class="container">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <form action="code.php" method="POST" enctype="multipart/form-data" id="js-upload-form">
            <div class="form-inline">
              <div class="form-group">
                <input type="file" name="image" id="js-upload-files" multiple>
			  </div>
              <input type="submit" class="btn btn-default" id="js-upload-submit" name="Upload Files">
            </div>
          </form>
